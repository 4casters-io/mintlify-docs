...
- `"Bet Size exceeds quantity available, which is $X.XX"` — the resting offer you tried to take was partially or fully consumed by another taker before your request landed.
...
{
  "error": {
    "message": "Bet Size exceeds quantity available, which is $42.50",
    "code": 409
  }
}
```
